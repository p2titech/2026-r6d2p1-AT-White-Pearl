error id: file://<WORKSPACE>/src/ex01/MTLineage.java
file://<WORKSPACE>/src/ex01/MTLineage.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[23,33]
...
public class MTLineage implements ILineage {
    ...
    // 人物が存在しないためthisを返す
    public ILineage getFather() r@@eturn this;
    public ILineage getMother() return this;
}
...
QDox parse error in file://<WORKSPACE>/src/ex01/MTLineage.java